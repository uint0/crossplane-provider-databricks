...
PROJECT_REPO := github.com/uint0/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_DOWNLOAD_NAME := terraform-provider-databricks-databricks
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-databricks-databricks-1.13.0
